  ...
  return (
    <div className='w-full py-[10rem] px-4 projectwave bg-white relative'>
        ...
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
            ...
            <div className='fade-in-left w-full flex flex-col py-4 my-4 rounded-lg hover:scale-105 duration-300 bg-white'>
            ...
            <div className='fade-in w-full flex flex-col py-4 my-4 rounded-lg hover:scale-105 duration-300 bg-white'>
            ...
            <div className='fade-in-right w-full flex flex-col py-4 my-4 rounded-lg hover:scale-105 duration-300 bg-white'>
