    ...
    <div className='w-full py-[10rem] px-4 bg-white'>
        ...
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
            ...
            <div className='w-full shadow-xl flex flex-col py-4 my-4 rounded-lg hover:scale-105 duration-300'>
                ...
                <button className='bg-[#00df9a] w-[100px] rounded-md font-medium my-6 mx-auto px-6 py-3'><a href='https://github.com/HaleBradley/Backend-Authentication' target='_blank' rel="noreferrer">Open</a></button>
            </div>
            ...
            <div className='w-full shadow-xl flex flex-col py-4 my-4 rounded-lg hover:scale-105 duration-300'>
                ...
                <button className='bg-black text-[#00df9a] w-[100px] rounded-md font-medium my-6 mx-auto px-6 py-3'><a href='https://github.com/HaleBradley/ArmorStandGUI' target='_blank' rel="noreferrer">Open</a></button>
            </div>
            ...
            <div className='w-full shadow-xl flex flex-col py-4 my-4 rounded-lg hover:scale-105 duration-300'>
                ...
                <button className='bg-[#00df9a] w-[100px] rounded-md font-medium my-6 mx-auto px-6 py-3'><a href='https://github.com/HaleBradley/Personal-Portfolio-Website' target='_blank' rel="noreferrer">Open</a></button>
            </div>
        </div>
    </div>
  )
