                ...
                <div className='flex flex-col sm:flex-row justify-between'>
                    <div className='grid grid-cols-3'>
                        <div className='justify-center justify-self-center mx-auto px-12'>
                            ...
                            <button onClick={() => {navigator.clipboard.writeText('haledev')}} className='bg-accent w-[100px] rounded-md font-medium my-6 mx-auto py-3'>Copy</button>
                        </div>
                        <div className='justify-center justify-self-center mx-auto px-12'>
                            <FaTwitter size={50} className='mx-auto' />
                            <button onClick={() => {navigator.clipboard.writeText('@HaleTheDev')}} className='bg-accent w-[100px] rounded-md font-medium my-6 ms-1 px-6 py-3'>Copy</button>
                        </div>
                        <div className='justify-center justify-self-center mx-auto px-12'>
                            <MdEmail size={50} className='mx-auto' />
                            <button onClick={() => {navigator.clipboard.writeText('hbradley786@gmail.com')}} className='bg-accent w-[100px] rounded-md font-medium my-6 px-6 py-3'>Copy</button>
                        </div>
                    </div>
                </div>
            </div>
