...
const Projects = () => {
  return (
    <div className='w-full px-4 projectwave bg-white relative'>
        <SectionWave />
        <h2 className='text-center md:text-6xl sm:text-5xl text-4xl font-bold mb-1 text-black z-10'>Projects</h2>
        <p className=' text-center md:text-3xl sm:text-2xl text-xl font-bold text-gray-500 mb-4 z-10'>See more on my <a href='https://github.com/HaleBradley' target='_blank' rel="noreferrer" className='text-[#0099ff] underline z-10'>GitHub</a></p>
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8 z-10'>
            ...
            <div className='w-full flex flex-col py-4 my-4 rounded-lg hover:scale-105 duration-300 bg-white z-10'>
