    ...
    <div className='w-full bg-white py-16 px-4'>
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
            ...
            <div className='flex flex-col justify-center'>
                <p className='text-[#00df9a] font-bold'>TODO</p>
                <h1 className='md:text-4xl sm:text-3xl text-2xl font-bold py-2'>WHAT SHOULD I PUT HERE?</h1>
                ...
                <button className='bg-black text-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto md:mx-0 py-3'>Button</button>
            </div>
        </div>
    </div>
  )
